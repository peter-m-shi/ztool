...
usage() {
	...
	echo "   pull   pull from the given branch, from current branch if no params."
	echo "   push   push to current remote branch. It will pull from super branch before push action"
